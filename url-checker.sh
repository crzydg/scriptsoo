#!/bin/bash
# some variables for your conveniance
thisday=$(date +%Y-%m-%d)
outfile="$thisday"_output.csv
...
echo "URL;IP;HTTP_STATUS;REMARKS" > $outfile
...
#    fi
    ...
    echo "${url};${ip};${http_code};${remarks}" >> $outfile
  fi
